...
flags.DEFINE_string(
    "output_dir", os.path.join(root_path, 'output\\result_dir'),
...
#         raise ValueError("At least one of `do_train` or `do_eval` must be True.")
    ...
    if FLAGS.do_predict:
        ...
        with codecs.open(os.path.join(FLAGS.output_dir, 'entity_level_predicted_result.txt'), 'w', encoding='utf-8') as fd:
